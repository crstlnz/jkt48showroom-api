...
// export async function getTheaterDetail(
//   id: string,
//   retry = 1,
//   headers: HeadersInit,
// ): Promise<{ show: JKT48.Theater[], members: JKT48.Member[] }> {
//   try {
...
//       const title = (
//         show.querySelector('td:nth-child(2)')?.textContent ?? ''
//       ).trim()
//       const team
//         = show.querySelector('td:nth-child(2) img')?.getAttribute('src') ?? ''
//       const dateString = (
...
//       const date = !clock
//         ? dayjs(dateString[0], 'dddd, D.M.YYYY')
//         : dayjs(`${dateString[0]} ${clock}`, 'dddd, D.M.YYYY H:mm')
